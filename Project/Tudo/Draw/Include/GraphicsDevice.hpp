...
#define TUDO_RENDERER_MESH_SKYBOX_STATE			(BGFX_STATE_WRITE_RGB | BGFX_STATE_WRITE_A | BGFX_STATE_DEPTH_TEST_LESS)
#define TUDO_RENDERER_MESH_TRANSPARENT_STATE	(BGFX_STATE_BLEND_ALPHA | BGFX_STATE_CULL_CCW | TUDO_RENDERER_MESH_SKYBOX_STATE)
